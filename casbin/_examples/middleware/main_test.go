...
func TestCasbinMiddleware(t *testing.T) {
	...
	tt := []ttcasbin{
		...
		{"alice", "alicepass", "/dataset1/resource2", "POST", 404},
		...
		{"bob", "bobpass", "/dataset2/resource2", "POST", 404},
		{"bob", "bobpass", "/dataset2/resource2", "DELETE", 404},

		{"bob", "bobpass", "/dataset2/folder1/item1", "GET", 404},
		{"bob", "bobpass", "/dataset2/folder1/item1", "POST", 200},
		{"bob", "bobpass", "/dataset2/folder1/item1", "DELETE", 404},
		{"bob", "bobpass", "/dataset2/folder1/item2", "GET", 404},
		{"bob", "bobpass", "/dataset2/folder1/item2", "POST", 200},
		{"bob", "bobpass", "/dataset2/folder1/item2", "DELETE", 404},
	}
